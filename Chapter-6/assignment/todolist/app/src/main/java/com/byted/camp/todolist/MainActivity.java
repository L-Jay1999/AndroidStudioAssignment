...
//        notesAdapter = new NoteListAdapter(todoDatabase.noteOperator());
        Adapter adapter = new Adapter();
        notesAdapter = new NoteListAdapter(adapter);
...
//        List<Note> notes = TodoDatabase.getInstance(this).noteOperator().getAll();
//        return notes;
//    }
