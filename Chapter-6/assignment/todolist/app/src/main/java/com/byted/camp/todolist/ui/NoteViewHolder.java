...
//    }
    ...
    public NoteViewHolder(@NonNull View itemView, MainActivity.Adapter operator) {
        super(itemView);
        this.operator = operator;
...
//        Date d = SIMPLE_DATE_FORMAT.parse(note.getDate());
        dateText.setText(note.getDate());

        checkBox.setOnCheckedChangeListener(null);

        checkBox.setChecked(State.from(note.getState()) == State.DONE);
